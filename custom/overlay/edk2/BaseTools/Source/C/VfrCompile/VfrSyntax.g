...
vfrStatementOptionalEndIfSemicolon :
  << LT(2)->getType() == RefreshGuid
   || LT(2)->getType() == GuidOp
   || LT(2)->getType() == Locked
   || LT(2)->getType() == Image
   || LT(2)->getType() == EndIf
   ...
   || LT(2)->getType() == Default
   || LT(2)->getType() == GrayOutIf
  >>? ";"
  |
  ;
...
vfrStatementInconsistentIf :
  ...
  { FLAGS "=" flagsField ( "\|" flagsField )* "," }
  vfrStatementExpression[0]
  E:EndIf vfrStatementOptionalEndIfSemicolon          << CRT_END_OP (E); >>
  ;
