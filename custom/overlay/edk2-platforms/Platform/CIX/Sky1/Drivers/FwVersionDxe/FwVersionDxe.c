  ...
  )
{
  ...
  FwVerUefiSize = MIN (
                    StrLen (FwVerUefiBuff),
                    sizeof (CixFwVerProtocol.FwHeader.FwVersion) - 1
                    );
  ZeroMem (
    CixFwVerProtocol.FwHeader.FwVersion,
    sizeof (CixFwVerProtocol.FwHeader.FwVersion)
    );
  UnicodeToAscii (
    FwVerUefiBuff,
    FwVerUefiSize,
