...
Device (DP00) {
  ...
  Method (_STA, 0x0, Serialized) {
    Local0 = \_SB.GETV(ARV_DPU_00_SUPPORT_OFFSET)
    If(Local0){
        Return (0xF)
    }
    Return (0x0)
...
Device (DP01) {
  ...
  Method (_STA, 0x0, Serialized) {
    Local0 = \_SB.GETV(ARV_DPU_01_SUPPORT_OFFSET)
    If(Local0){
        Return (0xF)
    }
    Return (0x0)
...
Device (DP02) {
  ...
  Method (_STA, 0x0, Serialized) {
    Local0 = \_SB.GETV(ARV_DPU_02_SUPPORT_OFFSET)
    If(Local0){
        Return (0xF)
    }
    Return (0x0)
...
Device (DP03) {
  ...
  Method (_STA, 0x0, Serialized) {
    Local0 = \_SB.GETV(ARV_DPU_03_SUPPORT_OFFSET)
    If(Local0){
        Return (0xF)
    }
    Return (0x0)
...
Device (DP04) {
  ...
  Method (_STA, 0x0, Serialized) {
    Local0 = \_SB.GETV(ARV_DPU_04_SUPPORT_OFFSET)
    If(Local0){
        Return (0xF)
    }
    Return (0x0)
