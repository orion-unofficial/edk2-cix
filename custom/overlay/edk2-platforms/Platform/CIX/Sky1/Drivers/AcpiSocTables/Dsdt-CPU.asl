...
Device (CPU4)
{
    ...
    Name (_CPC, Package()
      CPPC_PACKAGE_INIT (CORE_4_5_DESIRED_PERF_REG, 0, 1, CORE_4_5_HIGHEST_PERF, CORE_4_5_NOMINAL_PERF, CORE_4_5_LOWEST_NON_LINEAR_PERF, CORE_4_5_LOWEST_PERF, CIX_A720_REF_PERF)
    )
    Name (_PSD, Package () {
