...
#define CIX_A720_REF_PERF  0x0C4E
#define CIX_A520_REF_PERF  0x04D8
#else
#define CIX_A720_REF_PERF  REF_PERF
#define CIX_A520_REF_PERF  REF_PERF
#endif
...
Device (CPU0)
{
    ...
    Name (_CPC, Package()
      CPPC_PACKAGE_INIT (CORE_0_TO_3_DESIRED_PERF_REG, 0, 1, CORE_0_TO_3_HIGHEST_PERF, CORE_0_TO_3_NOMINAL_PERF, CORE_0_TO_3_LOWEST_NON_LINEAR_PERF, CORE_0_TO_3_LOWEST_PERF, CIX_A720_REF_PERF)
    )
    Name (_PSD, Package () {
...
Device (CPU2)
{
    ...
    Name (_CPC, Package()
      CPPC_PACKAGE_INIT (CORE_0_TO_3_DESIRED_PERF_REG, 0, 1, CORE_0_TO_3_HIGHEST_PERF, CORE_0_TO_3_NOMINAL_PERF, CORE_0_TO_3_LOWEST_NON_LINEAR_PERF, CORE_0_TO_3_LOWEST_PERF, CIX_A520_REF_PERF)
    )
    Name (_PSD, Package () {
      Package(){5, 0, 0, 0xFD, 4}
    })
...
Device (CPU4)
{
    ...
    Name (_CPC, Package()
      CPPC_PACKAGE_INIT (CORE_4_5_DESIRED_PERF_REG, 0, 1, CORE_4_5_HIGHEST_PERF, CORE_4_5_NOMINAL_PERF, CORE_4_5_LOWEST_NON_LINEAR_PERF, CORE_4_5_LOWEST_PERF, CIX_A520_REF_PERF)
    )
    Name (_PSD, Package () {
...
Device (CPU6)
{
    ...
    Name (_CPC, Package()
      CPPC_PACKAGE_INIT (CORE_6_7_DESIRED_PERF_REG, 0, 1, CORE_6_7_HIGHEST_PERF, CORE_6_7_NOMINAL_PERF, CORE_6_7_LOWEST_NON_LINEAR_PERF, CORE_6_7_LOWEST_PERF, CIX_A720_REF_PERF)
    )
    Name (_PSD, Package () {
...
Device (CPU8)
{
    ...
    Name (_CPC, Package()
      CPPC_PACKAGE_INIT (CORE_8_9_DESIRED_PERF_REG, 0, 1, CORE_8_9_HIGHEST_PERF, CORE_8_9_NOMINAL_PERF, CORE_8_9_LOWEST_NON_LINEAR_PERF, CORE_8_9_LOWEST_PERF, CIX_A720_REF_PERF)
    )
    Name (_PSD, Package () {
...
Device (CP10)
{
    ...
    Name (_CPC, Package()
      CPPC_PACKAGE_INIT (CORE_10_11_DESIRED_PERF_REG, 0, 1, CORE_10_11_HIGHEST_PERF, CORE_10_11_NOMINAL_PERF, CORE_10_11_LOWEST_NON_LINEAR_PERF, CORE_10_11_LOWEST_PERF, CIX_A720_REF_PERF)
    )
    Name (_PSD, Package () {
