...
Device (SUB0)
{
  ...
  {
    USB_CIX_DEVICE_STA (\_SB.GETV(ARV_USB3_TYPEC_DRD_ENABLE_OFFSET))
  }
...
Device (SUB1)
{
  ...
  Method (_STA)               // _STA: Device status
  {
    USB_CIX_DEVICE_STA (\_SB.GETV(ARV_USB3_TYPEC_HOST0_ENABLE_OFFSET))
  }
...
Device (SUB2)
{
  ...
  Method (_STA)               // _STA: Device status
  {
    USB_CIX_DEVICE_STA (\_SB.GETV(ARV_USB3_TYPEC_HOST1_ENABLE_OFFSET))
  }
...
Device (SUB3)
{
  ...
  Method (_STA)               // _STA: Device status
  {
    USB_CIX_DEVICE_STA (\_SB.GETV(ARV_USB3_TYPEC_HOST2_ENABLE_OFFSET))
  }
...
Device (SUB4)
{
  ...
  Method (_STA)               // _STA: Device status
  {
    USB_CIX_DEVICE_STA (\_SB.GETV(ARV_USB3_TYPEA_DRD0_ENABLE_OFFSET))
  }
...
Device (SUB5)
{
  ...
  Method (_STA)               // _STA: Device status
  {
    USB_CIX_DEVICE_STA (\_SB.GETV(ARV_USB3_TYPEA_DRD1_ENABLE_OFFSET))
  }
...
Device (HUB0) //High Speed USB 0, USB2.0
{
  ...
  Method (_STA)               // _STA: Device status
  {
    USB_CIX_DEVICE_STA (\_SB.GETV(ARV_USB2_HOST0_ENABLE_OFFSET))
  }
...
Device (HUB1) //High Speed USB 1, USB2.0
{
  ...
  Method (_STA)               // _STA: Device status
  {
    USB_CIX_DEVICE_STA (\_SB.GETV(ARV_USB2_HOST1_ENABLE_OFFSET))
  }
...
Device (HUB2) //High Speed USB 2, USB2.0
{
  ...
  Method (_STA)               // _STA: Device status
  {
    USB_CIX_DEVICE_STA (\_SB.GETV(ARV_USB2_HOST2_ENABLE_OFFSET))
  }
...
Device (HUB3) //High Speed USB 3, USB2.0
{
  ...
  Method (_STA)               // _STA: Device status
  {
    USB_CIX_DEVICE_STA (\_SB.GETV(ARV_USB2_HOST3_ENABLE_OFFSET))
  }
