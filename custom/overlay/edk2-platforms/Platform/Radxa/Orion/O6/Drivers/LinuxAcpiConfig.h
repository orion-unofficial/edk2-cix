...
#define USBC0_GENERIC_XHCI_VISIBLE  1
...
#define USBC1_GENERIC_XHCI_VISIBLE  0
...
#define USBC2_GENERIC_XHCI_VISIBLE  1
...
#define USBC3_GENERIC_XHCI_VISIBLE  0

#define USBA4_GENERIC_XHCI_VISIBLE  1
#define USBA5_GENERIC_XHCI_VISIBLE  1
#define USBH6_GENERIC_XHCI_VISIBLE  1
#define USBH7_GENERIC_XHCI_VISIBLE  1
#define USBH8_GENERIC_XHCI_VISIBLE  1
#define USBH9_GENERIC_XHCI_VISIBLE  1
