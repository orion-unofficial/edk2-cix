                           ...
                           const te_hwa_aca_t *aca_hwa)
{
    ...
    sram_pool->max_size = aca_hwa->get_core_max_op_len((te_hwa_aca_t *)aca_hwa);
    TE_ASSERT(sram_pool->max_size > 0);
    sram_pool->max_size = sram_pool->max_size / 8;
