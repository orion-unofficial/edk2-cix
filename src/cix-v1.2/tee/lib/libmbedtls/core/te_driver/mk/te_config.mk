...
TOP_DIR             ?= $(shell pwd -P | sed "s@/lib/libmbedtls/core/te_driver/mk/.*@@g")
...
# TE OTP PUF standby enable: y|n. PUF=1 for y. Or n otherwise.
TE_OTP_PUF_STB_EN   ?= $(if $(filter x1,x$(PUF)),y,n)
