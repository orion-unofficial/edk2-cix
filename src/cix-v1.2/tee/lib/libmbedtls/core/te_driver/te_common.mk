...
SHARED_DIR     := $(TOP_DIR)/lib/libhosal
EXTERN_DIR     := $(TOP_DIR)/lib/libhosal
SQLIST_DIR      := $(EXTERN_DIR)/misc/sqlist
HOSAL_API_DIR  := $(SHARED_DIR)/apis
...
ifeq ($(TE_KASUMI),y)
TE_CFLAGS      += -DTE_KASUMI_C
endif

ifeq ($(TE_SNOW3G),y)
TE_CFLAGS      += -DTE_SNOW3G_C
endif
