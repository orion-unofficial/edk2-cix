...
#define MBEDTLS_TEST_OK 0
#define MBEDTLS_TEST_FAIL 1
...
// TODO snprintf is not full-functioned
#if 0
...
{
	return (test_snprintf(0, "xxxxxxxxx", -1) != 0 || test_snprintf(1, "", -1) != 0 ||
		test_snprintf(2, "1", -1) != 0 || test_snprintf(3, "12", -1) != 0 || test_snprintf(4, "123", 3) != 0 ||
...
/* Heap test comes last */
	...
	{ "hmac", mbedtls_hmac_self_test },
#endif
#if defined(MBEDTLS_SM4_C)
	{ "sm4", mbedtls_sm4_self_test },
#endif
#if (defined(MBEDTLS_ECDSA_C) && defined(MBEDTLS_SHA1_C))
	{ "ecdsa", mbedtls_ecdsa_self_test },
#endif
#if (defined(MBEDTLS_SM2DSA_C) && defined(MBEDTLS_SM3_C))
	{ "sm2dsa", mbedtls_sm2dsa_self_test },
#endif
	{ NULL, NULL }
};

int mbedtls_te_selftest(void)
{
