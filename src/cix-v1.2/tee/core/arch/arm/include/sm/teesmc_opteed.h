...
/*
 * Issued when returning from "request_to_tf_a" vector
 *
 * Register usage:
 * r0/x0	SMC Function ID, TEESMC_OPTEED_RETURN_SYSTEM_RESET_DONE
 */
#define TEESMC_OPTEED_FUNCID_REQ_TO_SE	9
#define TEESMC_OPTEED_REQUEST_TO_SE_DONE \
	TEESMC_OPTEED_RV(TEESMC_OPTEED_FUNCID_REQ_TO_SE)

/*
 * Issued when returning from "tee_panic_smc" vector
 *
 * Register usage:
 * r0/x0	SMC Function ID, TEESMC_OPTEED_RETURN_SYSTEM_RESET_DONE
 */
#define TEESMC_OPTEED_FUNCID_TEE_PANIC	10
#define TEESMC_OPTEED_TEE_PANIC_DONE \
	TEESMC_OPTEED_RV(TEESMC_OPTEED_FUNCID_TEE_PANIC)
