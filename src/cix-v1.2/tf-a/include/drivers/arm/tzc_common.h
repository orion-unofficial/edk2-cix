...
#define TZC_REGION_ATTR_S_RD_MASK			U(0x1 << TZC_REGION_ATTR_S_RD_SHIFT)
#define TZC_REGION_ATTR_S_WR_MASK			U(0x1 << TZC_REGION_ATTR_S_WR_SHIFT)
#define TZC_REGION_ATTR_SEC_MASK			U(0x3 << TZC_REGION_ATTR_SEC_SHIFT)
