...
class CustomTogglePcdsTest(unittest.TestCase):
    ...
    def test_cpu_performance_order_keeps_physical_cppc_data(self) -> None:
    ...
    def test_custom_policy_overlay_materialization_keeps_unchanged_companions_as_symlinks(self) -> None:
        cases = (
            ...
            ("custom/overlay/edk2-platforms/Platform/Radxa/Platforms/CIX/Sky1/Drivers/PlatformConfigDxe/PlatformConfigHii.uni", True),
