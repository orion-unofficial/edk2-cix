...
def cases(repo: Path) -> list[Case]:
    ...
    make_targets = [
        ...
        make_help_case(repo, "help-dev-source"),
        make_help_case(repo, "help-dev-verify"),
        make_help_case(repo, "help-dev-maintenance"),
        ...
        make_case(repo, "inspect-import-conflicts"),
        make_case(repo, "resolve-conflicts"),
        make_case(repo, "propagate-release-branches"),
        make_case(repo, "update-release-tags"),
        ...
        make_case(repo, "publish-source-update"),
        make_case(repo, "check-source-metadata"),
        make_case(repo, "check-remote-source-coherence"),
        make_case(repo, "prepare-ci-source-refs"),
        ...
        make_help_case(repo, "verify-source-policy-help"),
        make_help_case(repo, "verify-source-lifecycle-help"),
        ...
        make_help_case(repo, "inspect-import-conflicts-help"),
        make_help_case(repo, "resolve-conflicts-help"),
        make_help_case(repo, "update-release-tags-help"),
        make_help_case(repo, "check-ref-integrity-help"),
        make_help_case(repo, "check-identity-integrity-help"),
        make_help_case(repo, "verify-identity-integrity-help"),
        make_help_case(repo, "check-vendor-workflow-drift-help"),
        make_help_case(repo, "check-upstream-versions-help"),
        make_help_case(repo, "check-source-metadata-help"),
        make_help_case(repo, "check-remote-source-coherence-help"),
        make_help_case(repo, "refresh-source-metadata-help"),
        make_help_case(repo, "create-minimised-clone-help"),
        make_help_case(repo, "verify-minimised-clone-help"),
        make_help_case(repo, "prune-help"),
        make_help_case(repo, "refresh-help-cache-help"),
        make_help_case(repo, "check-help-cache-help"),
        make_help_case(repo, "check-first-output-latency-help"),
        make_help_case(repo, "ref-report-help"),
        make_help_case(repo, "cleanup-report-help"),
    ...
    script_help = [
        ...
        "scripts/check_remote_source_coherence.py",
        ...
        "scripts/inspect_import_conflicts.py",
        "scripts/resolve_import_conflicts.py",
        ...
        "scripts/publish_source_update.py",
