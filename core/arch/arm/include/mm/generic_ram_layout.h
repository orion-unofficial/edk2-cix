...
#define TZ_TFA_SHM_BASE		CFG_TZ_TF_A_SHM
#define TZ_TFA_SHM_SIZE		CFG_TZ_TF_A_SIZE
#endif

#if defined(CFG_TEE_KEY_META_SHM)
#define TEE_KEY_META_SHM_BASE		CFG_TEE_KEY_META_SHM
#define TEE_KEY_META_SHM_SIZE		CFG_TEE_KEY_META_SIZE
#endif
