...
This checklist is intentionally focused on the behavior we care about for this
repo:
...
- `dbx` update behavior and regressions
...
If flashing a different firmware does not change Secure Boot behavior:
