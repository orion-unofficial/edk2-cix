...
packages. Direct host builds require ACPICA `20260408`; in particular, the
older macOS Homebrew `20200925` compiler is not used for current sources.
...
[`/.devcontainer/devcontainer.json`](https://github.com/orion-unofficial/edk2-cix/blob/source/unofficial/1.3/current/.devcontainer/devcontainer.json).
